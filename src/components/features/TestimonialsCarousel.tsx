...
const TESTIMONIALS_AR: Testimonial[] = [
    {
        ...
        rating: 5,
        comment: 'منظر خلاب للغاية! فيلا البحر الميت الملكية فاقت كل التوقعات. المسبح اللامتناهي عند غروب الشمس ذكرى سنعتز بها إلى الأبد.',
        avatar: '👩‍💼',
        stayedAt: 'فيلا البحر الميت الملكية'
    },
    {
        id: 't2',
        name: 'خالد العتيبي',
        ...
        rating: 5,
        comment: 'منتجع غابات عجلون كان سحراً خالصاً. الاستيقاظ على صوت العصافير ورائحة أشجار الصنوبر هو الهروب الذي كنا نحتاجه بالضبط.',
        avatar: '👨‍✈️',
        stayedAt: 'منتجع غابات عجلون'
    },
    {
        id: 't3',
        name: 'ماريا غارسيا',
        ...
        rating: 5,
        comment: 'أحببنا التاريخ في نزل جرش التراثي. شعرنا بالأصالة والراحة في آن واحد. الفطور التقليدي في الحديقة كان لذيذاً!',
        avatar: '👩‍🎨',
        stayedAt: 'نزل جرش التراثي'
    },
    {
        id: 't4',
        name: 'جيمس تشن',
        location: 'سنغافورة',
        rating: 5,
        comment: 'بنتهاوس عمان سكاي بمستوى عالمي. منظر أضواء المدينة ليلاً مذهل، والموقع في عبدون مثالي.',
        avatar: '👨‍💻',
        stayedAt: 'بنتهاوس عمان سكاي'
    },
    {
        id: 't5',
        name: 'ليلى مسعد',
        ...
        rating: 5,
        comment: 'مزرعة وادي الملح كانت متعة لأطفالنا. كرم الضيافة الأردني الأصيل في أبهى صوره. شعرنا وكأننا مع عائلتنا.',
        avatar: '👩‍⚕️',
        stayedAt: 'مزرعة وادي الملح'
    }
];
